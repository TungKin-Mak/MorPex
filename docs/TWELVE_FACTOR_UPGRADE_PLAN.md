...
*实施状态（2026-08-26）：U1/U2+U3/U4 及 P0 加固、P1 三缺口全部完成并推送。遗留：真实网关判定质量补验（配额恢复后跑 data/tmp-u1v/verify-intent.mts）；技术类辅助 prompt（extractJson/ContextDistiller）收编属 P2 决策。
