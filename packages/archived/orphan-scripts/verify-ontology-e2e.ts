...
import { systemMetadataGraph } from '../packages/core/src/knowledge/graph/SystemMetadataGraph.js';
...
async function main() {
  ...
  // ── Step 1: Bootstrap ──
  console.log('\n--- Step 1: 启动系统 ---');
  const { companyFacade, container, ontology, forcedQueryGuard } = await bootstrapUnified({ eventStore });
