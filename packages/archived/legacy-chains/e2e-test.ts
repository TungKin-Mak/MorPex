...
import { IntentPlugin } from './src/planner/goal-intelligence/intent/plugin.js';
import type { IntentResult } from './src/planner/goal-intelligence/intent/types.js';
