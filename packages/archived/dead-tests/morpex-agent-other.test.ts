...
async function main() {
  ...
  console.log('\n--- 5. ExecutionOrchestrator ---');
  try {
    const eo = await import('../src/governance/control-plane/orchestrator/ExecutionOrchestrator.js');
  ...
  console.log('\n--- 17. Builtin Tools ---');
  try {
    const bt = await import('../src/infrastructure/tools/builtin-tools.js');
  ...
  try {
    const kp = await import('../src/knowledge/graph/knowledge/plugin.js');
  ...
  console.log('\n--- 23. Artifact Plugin ---');
  try {
    const ap = await import('../src/knowledge/artifact/registry/plugin.js');
  ...
  console.log('\n--- 28. Intent Plugin ---');
  try {
    const ip2 = await import('../src/cognition/planning/goal-intelligence/intent/plugin.js');
  ...
  try {
    ...
    for (const t of tools) {
      try {
        const mod = await import(`../src/infrastructure/tools/${t}.js`);
