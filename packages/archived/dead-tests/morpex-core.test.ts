...
import { ExecutionIdentity } from '../src/infrastructure/common/ExecutionIdentity.js';
...
import { PluginSystem } from '../src/infrastructure/common/PluginSystem.js';
import { MorPexKernel } from '../src/infrastructure/common/Kernel.js';
import { LLMProvider } from '../src/services/LLMProvider.js';
import type { MorPexEvent, AgentRuntimeAdapter, ExecutionRequest, ExecutionResult, RuntimeHealth, MorPexPlugin } from '../src/infrastructure/common/types.js';
...
console.log('\n📋 11. Intent Plugin\n');
{
  const { IntentResolver } = await import('../src/cognition/planning/goal-intelligence/intent/IntentResolver.js');
  ...
  const { IntentPlugin } = await import('../src/cognition/planning/goal-intelligence/intent/plugin.js');
...
console.log('\n📋 13. FSM (状态机)\n');
{
  const { FSMEngine } = await import('../src/execution/runtime/fsm/FSMEngine.js');
...
{
  const { FSMPlugin } = await import('../src/execution/runtime/fsm/plugin.js');
...
console.log('\n📋 15. DAG\n');
{
  const { DAGEngine } = await import('../src/execution/runtime/dag/DAGEngine.js');
  ...
  const { DAGPlugin } = await import('../src/execution/runtime/dag/plugin.js');
...
console.log('\n📋 16. Exec Graph\n');
{
  const { ExecutionGraphEngine } = await import('../src/execution/runtime/execution-graph/ExecutionGraph.js');
  ...
  const { ExecGraphPlugin } = await import('../src/execution/runtime/execution-graph/plugin.js');
...
console.log('\n📋 17. Scheduler\n');
{
  const { SchedulerEngine } = await import('../src/execution/runtime/scheduler/SchedulerEngine.js');
  let ready: any = null;
  ...
  const { SchedulerPlugin } = await import('../src/execution/runtime/scheduler/plugin.js');
...
console.log('\n📋 18. Artifact\n');
{
  const { ArtifactRegistry } = await import('../src/knowledge/artifact/registry/ArtifactRegistry.js');
  ...
  const { createVersionSnapshot, formatVersion } = await import('../src/knowledge/artifact/registry/ArtifactVersion.js');
  ...
  const { ArtifactPlugin } = await import('../src/knowledge/artifact/registry/plugin.js');
...
pass += 14;
{
  ...
  const { MemoryWiki } = await import('../src/infrastructure/adapters/memory/index.js');
  // 使用隔离临时目录避免跨测试污染
  ...
  const { MemoryPlugin } = await import('../src/knowledge/memory/knowledge/plugin.js');
...
console.log('\n📋 20. Knowledge Graph\n');
{
  const { KnowledgeGraph } = await import('../src/knowledge/graph/knowledge/KnowledgeGraph.js');
  ...
  const { KnowledgeGraphPlugin } = await import('../src/knowledge/graph/knowledge/plugin.js');
...
console.log('\n📋 22. Orchestrator\n');
{
  const { AgentOrchestrator } = await import('../src/execution/harness/orchestrator/AgentOrchestrator.js');
  ...
  pass += 18;
  const { createOrchestratorPlugin } = await import('../src/execution/harness/orchestrator/plugin.js');
...
console.log('\n📋 23. Swarm\n');
{
  const { SwarmEngine } = await import('../src/execution/harness/swarm/SwarmEngine.js');
  ...
  pass += 14;
  const { createSwarmPlugin } = await import('../src/execution/harness/swarm/plugin.js');
