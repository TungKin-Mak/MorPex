...
async function main() {
  ...
  console.log('\n--- 14. CheckpointManager ---');
  try {
    const cm = await import('../src/execution/runtime/checkpoint/CheckpointManager.js');
  ...
  console.log('\n--- 18. MemoryHooks ---');
  try {
    const mh = await import('../src/knowledge/memory/MemoryHooks.js');
  ...
  console.log('\n--- 19. MemoryMessages ---');
  try {
    const mm = await import('../src/knowledge/memory/MemoryMessages.js');
