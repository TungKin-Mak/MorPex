...
{
  const modules = [
    ['MemoryHooks', '../src/knowledge/memory/MemoryHooks.js'],
    ['MemoryMessages', '../src/knowledge/memory/MemoryMessages.js'],
...
{
  const modules = [
    ['AgentOrchestrator', '../src/execution/harness/orchestrator/AgentOrchestrator.js'],
    ['SwarmEngine', '../src/execution/harness/swarm/SwarmEngine.js'],
