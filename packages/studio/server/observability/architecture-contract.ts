...
export const ARCHITECTURE_CONTRACT: ModuleContract[] = [
  ...
  { name: 'memory-wiki', required: true, expectedCallers: ['persistence-stage','context-stage'], expectedCallees: ['memory-retriever'], activation: 'always', layer: 'knowledge', description: '记忆维基' },
