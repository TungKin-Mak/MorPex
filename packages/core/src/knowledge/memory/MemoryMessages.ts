 ...
 *
 * 声明合并移到了 ../../infrastructure/adapters/pi-augmentations.ts。
 */

import type { AgentMessage } from '../../infrastructure/adapters/pi-types.js';

// ═══════════════════════════════════════════════════════════════
// 声明合并激活（导入适配层的模块扩展）
// ═══════════════════════════════════════════════════════════════

import '../../infrastructure/adapters/pi-augmentations.js';
