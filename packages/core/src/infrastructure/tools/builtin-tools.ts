...
import type { Static, TSchema } from '../../infrastructure/adapters/pi-ai-types.js';
import type { AgentTool, ExecutionEnv, AgentToolResult } from '../../infrastructure/adapters/pi-types.js';
