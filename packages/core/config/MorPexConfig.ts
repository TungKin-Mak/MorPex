...
export const MorPexConfigSchema = z.object({
  ...
  modelProvider: z.string().default('zhipu-glm'),
  modelId: z.string().default('glm-4.7-flash'),
  ...
  fsmModelProvider: z.string().default('zhipu-glm'),
  fsmModelId: z.string().default('glm-4.7-flash'),
