...
export const MorPexConfigSchema = z.object({
  ...
  modelProvider: z.string().default('opencode'),
  modelId: z.string().default('deepseek-v4-flash-free'),
  ...
  fsmModelProvider: z.string().default('opencode'),
  fsmModelId: z.string().default('deepseek-v4-flash-free'),
