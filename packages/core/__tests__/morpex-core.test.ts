...
console.log('\n📋 11. Intent Plugin\n');
{
  const { IntentResolver } = await import('../src/goal-intelligence/intent/IntentResolver.js');
  ...
  const { IntentPlugin } = await import('../src/goal-intelligence/intent/plugin.js');
...
console.log('\n📋 13. FSM (状态机)\n');
{
  const { FSMEngine } = await import('../src/runtime/fsm/FSMEngine.js');
...
{
  const { FSMPlugin } = await import('../src/runtime/fsm/plugin.js');
...
console.log('\n📋 15. DAG\n');
{
  const { DAGEngine } = await import('../src/runtime/dag/DAGEngine.js');
  ...
  const { DAGPlugin } = await import('../src/runtime/dag/plugin.js');
...
console.log('\n📋 16. Exec Graph\n');
{
  const { ExecutionGraphEngine } = await import('../src/runtime/execution-graph/ExecutionGraph.js');
  ...
  const { ExecGraphPlugin } = await import('../src/runtime/execution-graph/plugin.js');
...
console.log('\n📋 17. Scheduler\n');
{
  const { SchedulerEngine } = await import('../src/runtime/scheduler/SchedulerEngine.js');
  let ready: any = null;
  ...
  const { SchedulerPlugin } = await import('../src/runtime/scheduler/plugin.js');
...
console.log('\n📋 18. Artifact\n');
{
  ...
  const { createVersionSnapshot, formatVersion } = await import('../src/artifact/registry/ArtifactVersion.js');
  ...
  const { ArtifactPlugin } = await import('../src/artifact/registry/plugin.js');
...
pass += 14;
{
  ...
  const { MemoryPlugin } = await import('../src/memory/knowledge/plugin.js');
...
console.log('\n📋 20. Knowledge Graph\n');
{
  ...
  const { KnowledgeGraphPlugin } = await import('../src/metadata/knowledge/plugin.js');
...
console.log('\n📋 22. Orchestrator\n');
{
  ...
  pass += 18;
  const { createOrchestratorPlugin } = await import('../src/agent/harness/orchestrator/plugin.js');
...
console.log('\n📋 23. Swarm\n');
{
  ...
  pass += 14;
  const { createSwarmPlugin } = await import('../src/agent/harness/swarm/plugin.js');
